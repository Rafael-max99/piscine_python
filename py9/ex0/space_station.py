...
class SpaceStation(BaseModel):
    ...
    station_id: str = Field(..., min_length=3, max_length=10, description="Station id")
    ...
    power_level: float = Field(..., ge=0.0, le=100.0, description="Power level percent")
    oxygen_level: float = Field(..., ge=0.0, le=100.0, description="Oxygen level percent")
...
def display_station(station: SpaceStation) -> None:
    ...
    print(f"Last Maintenance: {station.last_maintenance}") # not sure
    if station.notes:
