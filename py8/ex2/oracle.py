...
def load_env_file() -> None:
    try:
        ...
        if env_path.exists():
			...
			print("[INFO] No .env file found, using defaults/environment variables")
	except ImportError:
...
def show_environment_info() -> None:
	...
	for var in defined_vars:
		source = "environment variable" if var in os.environ else ".env file or default"
