...
import os
import site
from pathlib import Path # Nao sei se posso fazer este import

def is_virtual_environment() -> bool:
    return sys.prefix != sys.base_prefix

def is_in_venv_v2() -> bool:
    return os.environ.get('VIRTUAL_ENV') is not None

def is_in_venv_v3() -> bool:
...
def get_site_packages() -> str:
    if is_virtual_environment():
        ...
        return os.path.join(sys.prefix, "lib", python_version, "site_packages")
    else:
